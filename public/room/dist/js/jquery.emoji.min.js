    ...
    Plugin.prototype = {
        _init: function () {
            ...
            if (!btn) {
                ...
                contentTop = this.$content.outerHeight() - 79;
                contentLeft = this.$content.outerHeight() - 65;
                $(newBtn).appendTo($('.barCon'));//修改处
            ...
            for (var i = 0; i < groupLength; i++) {
                ...
                panel = '<div id="emoji' + i + '" class="emoji_icons clearfix" style="' + (i === 0 ? '' : 'display:none;') + '"><ul>';
            ...
            $(emoji_container).appendTo($('.barCon'));//修改处

            btnTop =  $(btn).outerHeight() - 360;//修改处
            btnLeft = $(btn).outerHeight() - 5;//修改处
                    ...
                    if (target === $(btn)[0]) {
                        ...
                        if (code) {
                            if (field.nodeName === 'DIV') {
                                ...
                                insertHtml = '<img class="emoji_icon" src="' + imgSrc + '" code="'+code+'"/>';
            ...
            $('#emoji_container_' + ix + ' .emoji_icons a').mouseenter(function () {
                ...
                $('#emoji_container_' + ix + ' .emoji_preview img').attr('src', src).parent().hide();//把show()改成hide()
            });
