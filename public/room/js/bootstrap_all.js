 ...
 *
 **/
if (typeof jQuery === "undefined") { throw new Error("Need JavaScript requires jQuery") }
	...
	* ====================== */
	...
	Modal.prototype = {
		...
		init: function (element, options) {
			...
			if($.fn.draggable){
				var dragConfig=$.extend({/*handle:'.modal-header',*/cursor:'move',scroll:false,containment:'window'},options.dragConfig);
				if(this.$element.find(dragConfig.handle).length>0){
					this.$element.draggable(dragConfig);
				}
			}
