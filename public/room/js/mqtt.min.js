(function (f) {
    ...
    return function e(t, n, r) {
        ...
        1: [function (require, module, exports) {
            (function (process, global) {
                ...
                MqttClient.prototype.unsubscribe = function (topic, callback) {
                    var packet = {cmd: "unsubscribe", qos: 1, messageId: this._nextId()};
                    var that = this;
                ...
                MqttClient.prototype._handleAck = function (packet) {
                    ...
                    switch (type) {
                        ...
                        case"puback":
                            ...
                            break;
                        case"pubrec":
                            response = {cmd: "pubrel", qos: 2, messageId: mid};
                            this._sendPacket(response);
                            break;
                        case"suback":
                            delete this.outgoing[mid];
                            if (packet.granted.length === 1 && (packet.granted[0] & 128) !== 0) {
        ...
        }, {_process: 30, url: 49, "websocket-stream": 55}],
        5: [function (require, module, exports) {
            ...
            function WebSocket(url, protocols) {
                ...
                wx.connectSocket({url: url, protocols: protocols});
        ...
        6: [function (require, module, exports) {
            (function (process) {
                ...
                var defaultStoreOptions = {clean: true};
        ...
        }, {_process: 30, "readable-stream": 44, xtend: 58}],
        ...
        10: [function (require, module, exports) {
            (function (Buffer) {
                ...
                BufferList.prototype.copy = function copy(dst, dstStart, srcStart, srcEnd) {
                    ...
                    var copy = !!dst, off = this._offset(srcStart), len = srcEnd - srcStart, bytes = len,
                        bufoff = copy && dstStart || 0, start = off[1], l, i;
                ...
                BufferList.prototype.shallowSlice = function shallowSlice(start, end) {
                    ...
                    var startOffset = this._offset(start), endOffset = this._offset(end),
        ...
        }, {buffer: 12, "readable-stream/duplex": 35, util: 54}],
        ...
        }, {_process: 30, buffer: 12, "end-of-stream": 15, inherits: 18, "readable-stream": 44, "stream-shift": 47}],
        ...
        }, {"./writeToStream": 27, events: 16, inherits: 18, "safe-buffer": 46}],
        23: [function (require, module, exports) {
            "use strict";
            exports.parser = require("./parser");
            exports.generate = require("./generate");
            exports.writeToStream = require("./writeToStream")
        }, {"./generate": 22, "./parser": 26, "./writeToStream": 27}],
        24: [function (require, module, exports) {
            ...
            function generateBuffer(i) {
                ...
                buffer.writeUInt8(i & 255, 0 + 1, true);
                return buffer
            }
        ...
        }, {"./constants": 21, "./packet": 25, bl: 10, events: 16, inherits: 18}],
        27: [function (require, module, exports) {
            ...
            module.exports = generate
        }, {"./constants": 21, "./numbers": 24, "process-nextick-args": 29, "safe-buffer": 46}],
        ...
        }, {"./_stream_transform": 39, "core-util-is": 13, inherits: 18}],
        ...
        }, {"./_stream_duplex": 36, "core-util-is": 13, inherits: 18}],
        ...
        }, {"./util": 50, punycode: 31, querystring: 34}],
        ...
        }, {"./support/isBuffer": 53, _process: 30, inherits: 52}],
        ...
        }, {_process: 30, duplexify: 14, "readable-stream": 44, "safe-buffer": 46, ws: 56}],
